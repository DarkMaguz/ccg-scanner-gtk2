...
int main( int argc, char* argv[] )
{
	...
	Mat occludedSquare = imread( argv[1] );// Foto.JPG
...
Point2f computeIntersect( Vec2f line1, Vec2f line2 )
{
	...
	Point2f intersect( ( ( p1[0].x * p1[1].y - p1[0].y * p1[1].x ) * ( p2[0].x - p2[1].x ) - ( p1[0].x - p1[1].x ) * ( p2[0].x * p2[1].y - p2[0].y * p2[1].x ) ) / denom, ( ( p1[0].x * p1[1].y - p1[0].y * p1[1].x ) * ( p2[0].y - p2[1].y ) - ( p1[0].y - p1[1].y ) * ( p2[0].x * p2[1].y - p2[0].y * p2[1].x ) ) / denom );
