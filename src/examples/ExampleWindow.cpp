...
void ExampleWindow::on_start_button_clicked( void )
{
	...
	else
	{
		...
		m_WorkerThread = Glib::Threads::Thread::create( sigc::bind( sigc::mem_fun( m_Worker, &ExampleWorker::do_work ), this ) );
	}
...
void ExampleWindow::on_stop_button_clicked( void )
{
...
void ExampleWindow::update_start_stop_buttons( void )
{
...
void ExampleWindow::update_widgets( void )
{
...
void ExampleWindow::on_quit_button_clicked( void )
{
...
void ExampleWindow::notify( void )
{
	m_Dispatcher.emit();
}

void ExampleWindow::on_notification_from_worker_thread( void )
{
